...
print("[NEW CODE]nag_opt_params:{}".format(nag_opt_params))
...
print("[NEW CODE ]Check dataset object: {}, labels: {}".format(train_labeled_dataset, set(train_labeled_dataset.targets)))
